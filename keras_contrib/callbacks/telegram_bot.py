...
of a Keras training process using a Telegram bot
"""

# Import Telegram python API module:
...
# Optional import of matplotlib, for sending of convergence plots
try:
...
class DLBot(object):
    """  A class for interacting with a Telegram bot to monitor and control a Keras training process.
...
class TelegramBotCallback(Callback):
    ...
    def __init__(self, token, user_id=None):
        ...
        self.kbot = DLBot(token=token,user_id=user_id)
